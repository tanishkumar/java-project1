...
class myframe
{
	...
	myframe()
	{	
		f=new JFrame("Oneplus Club");
		f.getContentPane().setLayout(null);
		l1=new JLabel("Customer ID");
		t1=new JTextField(15);
		l5=new JLabel("**Welcome to Oneplus Club**");
		t1=new JTextField(15);
		...
		l1.setBounds(50,60,120,27);
		l2.setBounds(50,130,120,27);
		l3.setBounds(50,200,120,27);
		l4.setBounds(50,270,120,27);
		l5.setBounds(95,15,280,27);
		l5.setFont(new Font("Serif",Font.BOLD,20));
		t1.setBounds(220,60,180,27);
		t2.setBounds(220,130,180,27);
		t3.setBounds(220,200,180,27);
		t4.setBounds(220,270,180,27);
		b1.setBounds(50,340,80,27);
		b2.setBounds(140,340,80,27);
		b3.setBounds(230,340,80,27);
		b4.setBounds(320,340,80,27);
		b5.setBounds(50,410,80,27);
		b6.setBounds(185,410,80,27);
		b7.setBounds(320,410,80,27);
